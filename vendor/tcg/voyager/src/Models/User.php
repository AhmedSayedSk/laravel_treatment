...
class User extends Authenticatable implements UserContract
{
    ...
    public $additional_attributes = ['locale', 'specialty'];
    ...
    {
        $this->settings = $this->settings->merge(['specialty_id' => $value]);
    }

    public function getSpecialtyIdAttribute()
    {
        // get the name of the specialty from \App\Specialty model
        return \App\Models\Specialty::find($this->settings->get('specialty_id'))->name ?? null;
    }
